...
void main() {
  test('forceUpdate sends _force and returns applied', () async {
    ...
    final svc = SyncService(null, httpClient: mockClient, serverBase: 'http://localhost:8000');

    final res = await svc.forceUpdate(resourceType: 'product', id: 42, data: {'price': 10.0});
